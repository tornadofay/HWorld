...
namespace HWorld.Example
{
    internal sealed class MainForm : Form
    {
        ...
        private readonly Label _playerValue;
        private readonly Label _seedValue;
        private readonly Label _storyValue;
        private readonly TextBox _seedBox;
        private readonly ComboBox _toolBox;
        private readonly CheckBox _solidBox;
        private readonly Label _hintValue;
